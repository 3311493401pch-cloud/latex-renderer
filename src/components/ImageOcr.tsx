        ...
        {config.provider === 'siliconflow' && (
          <>
            ...
            <p className="image-ocr-tip">
              ...
              <br />
              ⚠️ 如果报 <code>Model disabled</code> 错误，说明该模型已停止服务，请在上方「模型」下拉框换一个可用模型。
            </p>
          </>
        )}
